...
public class GameScreen extends BaseScreen{
	...
	public void updateScreen(){
		...
		// draw the asteroid until it reaches the bottom of the screen
		//LEVEL 2
		else if(!status.isNewAsteroid() && boom > 2 && boom <= 7){
		...
		//LEVEL 3
			...
			if((asteroid.getX() + asteroid.getAsteroidWidth() >0 && bigAsteroid.getX() + bigAsteroid.getBigAsteroidWidth() > 0)){
				...
				asteroid.setLocation(this.getWidth() - asteroid.getAsteroidWidth(),
						rand.nextInt(this.getHeight() - asteroid.getAsteroidHeight() - 80));
				bigAsteroid.setLocation(this.getWidth() - bigAsteroid.getBigAsteroidWidth(), 
						rand.nextInt(this.getHeight() - bigAsteroid.getBigAsteroidHeight() - 80));
				}
			}
		
//		//LEVEL 4
//		else if (!status.isNewAsteroid() && boom > 19){
...
//		}
		...
		if(boom == 2 || boom == 8 /*|| boom == 19|| status.getLevel() == 2 || status.getLevel() == 8*/){
			restructure();
...
//		}
	...
	/*public void skipLevel(){
		...
		status.setLevel(status.getLevel());
	}*/
